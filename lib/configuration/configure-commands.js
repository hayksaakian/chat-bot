...
const embed = require('../commands/implementations/embed');
...
function registerCommandsFromFiles(commandRegistry, chatConnectedTo, config) {
  commandRegistry.registerCommand('!embed', embed);
  // enabled just to ping/pong the bot in production
  commandRegistry.registerCommand('!oooo', love);
  /*
